...
###subsample 1500 hvg genes out of total 3909
set.seed(0)
hvg2<-sample(row.names(logDataA3),1500)
logDataA3<-logDataA3[hvg2,]
logDataF3<-logDataF3[hvg2,]
...
plotFUN("results1500/uncFA.png", tsne.unc$Y, main="Uncorrected",  xlab="tSNE 1",ylab="tSNE 2")
plotFUNb("results1500/uncFAb.png", tsne.unc$Y, main="Uncorrected",  xlab="tSNE 1",ylab="tSNE 2")
...
pca.unc$x[ (pca.unc$x[,2]>(0.1)),2]<- (0.1)
plotFUN("results1500/pca_raw.png", pca.unc$x, subset=pca.retain, main="Uncorrected", ylim=c(-0.1, max(pca.unc$x[,2])),  xlab="PC 1",ylab="PC 2")
...
plotFUN("results1500/mnnFA.png", tsne.mnn$Y, main="MNN",  xlab="tSNE 1",ylab="tSNE 2")
plotFUNb("results1500/mnnFAb3.png", tsne.mnn$Y, main="MNN",  xlab="tSNE 1",ylab="tSNE 2")

set.seed(0)
tsne.mnn2 <- Rtsne(t.mnn, perplexity = 90)
plotFUN("results1500/mnnFA_conventsne.png", tsne.mnn2$Y, main="MNN",  xlab="tSNE 1",ylab="tSNE 2")
...
plotFUN("results1500/pca_mnn.png", pca.mnn$x, subset=pca.retain, main="MNN", ylim=c(-0.08,0.05),  xlab="PC 1",ylab="PC 2")
...
plotFUN("results1500/lmfitFA.png", tsne.lm$Y, main="limma",  xlab="tSNE 1",ylab="tSNE 2")
plotFUNb("results1500/lmfitFAb.png", tsne.lm$Y, main="limma",  xlab="tSNE 1",ylab="tSNE 2")
...
plotFUN("results1500/pca_lm.png", pca.lm$x, subset=pca.retain, main="limma", ylim=c(min(pca.lm$x[,2]), 0.05),  xlab="PC 1",ylab="PC 2")
...
plotFUN("results1500/combatFA.png", tsne.combat$Y, main="ComBat",  xlab="tSNE 1",ylab="tSNE 2")
plotFUNb("results1500/combatFAb.png", tsne.combat$Y, main="ComBat",  xlab="tSNE 1",ylab="tSNE 2")
...
pca.combat$x[ (pca.combat$x[,2]>(0.08)),2]<- (0.08)
plotFUN("results1500/pca_com.png", pca.combat$x, subset=pca.retain, main="ComBat", ylim=c(min(pca.combat$x[,2]), 0.05),  xlab="PC 1",ylab="PC 2")
...
pdf(file="results1500/legend.pdf", width=7, height=7)
