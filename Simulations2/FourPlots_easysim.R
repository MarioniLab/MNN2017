...
#######
png(file="easy_unc.png",width=900,height=700)
par(mfrow=c(1,1),mar=c(6,6,4,2),cex.axis=2,cex.main=3,cex.lab=2.5)
plot(tsne.unc$Y[1:N,1],tsne.unc$Y[1:N,2], pch=16,cex=2.5,col=alpha((clustlabels[1:N]),0.6),main="Uncorrected",xlim=c(-35,40),ylim=c(-40,40),xlab="tSNE 1",ylab="tSNE 2")
...
set.seed(0)
tsne.c<-Rtsne(all.dists2.c, is_distance=TRUE)#, perplexity = 50)

png(file="easy_mnn.png",width=900,height=700)
par(mfrow=c(1,1),mar=c(6,6,4,2),cex.axis=2,cex.main=3,cex.lab=2.5)
plot(tsne.c$Y[1:N,1],tsne.c$Y[1:N,2], pch=16,cex=2.5,col=alpha((clustlabels[1:N]),0.6),main="MNN corrected",xlim=c(-30,40),ylim=c(-40,40),xlab="tSNE 1",ylab="tSNE 2")
...
png(file="easy_lmfit.png",width=900,height=700)
par(mfrow=c(1,1),mar=c(6,6,4,2),cex.axis=2,cex.main=3,cex.lab=2.5)
plot(tsne.lm$Y[1:N,1],tsne.lm$Y[1:N,2], pch=16,cex=2.5,col=alpha((clustlabels[1:N]),0.6),main="limma corrected",xlim=c(-40,40),ylim=c(-30,30),xlab="tSNE 1",ylab="tSNE 2")
...
png(file="easy_combat.png",width=900,height=700)
par(mfrow=c(1,1),mar=c(6,6,4,2),cex.axis=2,cex.main=3,cex.lab=2.5)
plot(tsne.combat$Y[1:N,1],tsne.combat$Y[1:N,2], pch=16,cex=2.5,col=alpha((clustlabels[1:N]),0.6),main="ComBat corrected",xlim=c(-35,30),ylim=c(-25,30),xlab="tSNE 1",ylab="tSNE 2")
...
par(mfrow=c(1,1),mar=c(6,6,4,2),cex.axis=2,cex.main=3,cex.lab=2.5)
plot(tsne.c$Y[1,1],tsne.c$Y[1,2], pch=16,cex=2.5,col=alpha((clustlabels[1]),0.6),main="MNN corrected",xlim=c(-45,45),ylim=c(-45,45),xlab="tSNE 1",ylab="tSNE 2")
#points(tsne.c$Y[(N+1):(2*N),1],tsne.c$Y[(N+1):(2*N),2], pch=2,cex=3.5,col=(clustlabels[(N+1):(2*N)]))
leg.txt1=c("Cell type 1","Cell type 2","Cell type 3")
